...
Synapse is a Spring Boot backend for turning uploaded study notes into structured learning resources. Users can register, upload PDF notes, generate AI-powered summaries, create flashcard decks, and generate quizzes from saved notes.
...
| Method | Endpoint | Description | Auth |
| --- | --- | --- | --- |
| `POST` | `/api/notes/summarise` | Upload a PDF note, generate a summary, and save it | Yes |
...
- Only PDF upload is currently supported for note summarisation.
